...
from tkinter import PhotoImage, StringVar, Menu, Toplevel, IntVar , messagebox
...
#---------------------------------------------------------------------------------------------------------
    ...
    def run_command(self):
        ...
        elif self.v1.get() == '3':  # 3 = logout
            logout_failed_window = messagebox.askquestion('Warning', 'Logout cannot be initialized with timing\n Would you like to logout now?')
            if logout_failed_window == 'yes':
                logout()  
